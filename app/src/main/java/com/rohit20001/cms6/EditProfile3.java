...
public class EditProfile3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),profile3.class));
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etName.getText().toString().isEmpty()||etPhone.getText().toString().isEmpty()||
                    ...
                    Toast.makeText(EditProfile3.this,"One or more fields are Empty",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                user.updateEmail(Email).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(EditProfile3.this, "Email is changed", Toast.LENGTH_SHORT).show();
                        ...
                        documentReference.update(edited).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(EditProfile3.this, "Changes Successfully updated", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(getApplicationContext(),profile3.class));
                                finish();
                            }
                        });
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(EditProfile3.this, "Error in updating changes", Toast.LENGTH_SHORT).show();
                    }
                });
