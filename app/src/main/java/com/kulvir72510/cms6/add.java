        ...
        riversRef.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        user.put("model_name", mn);
                        user.put("color", c);
                        user.put("price", p);
                        user.put("gst",G);
                        user.put("other", O);
                        user.put("randomKey","images/"+randomKey);
                        fStore.collection("users").document(userId).collection("postUrl").add(user);

                        docData.put("carUrl","images/"+randomKey);

                        /*Map<String,Object> car = new HashMap<>();
                        car.put("carUrl","images/"+randomKey);
                        System.out.println(Id);;
                        fStore.collection("Models").document(Id).update(car);*/
